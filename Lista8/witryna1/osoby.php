...
<?php
    ...
    function pokaz_osoby()
    {
            ...
            if($x[0]!='.')
        {
            ...
            echo "<li> $dane->imię $dane->nazwisko  <a href='?x=$encoded_x' style=color:red>x</a></li>";
        } 
            echo "<li><form method=POST><input name=imię> <input name=nazwisko><input type=submit value=Dodaj></li>";
        echo "</ul>";
    }
